...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $_fields = ['nopol', 'nama', 'nik', 'alamat', 'norangka', 'nomesin', 'merk', 'tahun', 'warna', 'nohp', 'tahunpajak', 'pkb', 'swdkllj'];
...
<body>
    <div class="container">
        ...
        <form method="POST" id="pajakForm">
            ...
            <div class="form-section">
                <h2>Data Pemilik Kendaraan</h2>
                <div class="form-grid">
                    <div class="form-group">
                        <label for="nama">Nama Pemilik *</label>
                        <input type="text" id="nama" name="nama" placeholder="Contoh: Ahmad Santoso" value="<?php echo isset($input['nama']) ? $input['nama'] : ''; ?>">
                        <?php if (isset($errors['nama'])): ?>
                            <span class="error"><?php echo $errors['nama']; ?></span>
                        <?php endif; ?>
                    </div>
                    <div class="form-group">
                        <label for="nik">NIK KTP Pemilik *</label>
                        <input type="text" id="nik" name="nik" placeholder="nik KTP pemilik" value="<?php echo isset($input['nik']) ? $input['nik'] : ''; ?>">
                        <?php if (isset($errors['nik'])): ?>
                            <span class="error"><?php echo $errors['nik']; ?></span>
                        <?php endif; ?>
                    </div>
                    <div class="form-group">
                        <label for="alamat">Alamat *</label>
                        <input type="text" id="alamat" name="alamat" placeholder="Alamat Pemilik" value="<?php echo isset($input['alamat']) ? $input['norangka'] : ''; ?>">
